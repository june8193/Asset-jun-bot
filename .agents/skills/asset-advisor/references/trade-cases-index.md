...
상담 상황(종목, 업종, 심리 상태, 매매 패턴)과 매칭되는 핵심 태그를 확인한 후, 해당 상세 파일(`references/cases/*.md`)을 `view_file`로 On-Demand 로드하여 조언 근거로 인용합니다.

## 사례 색인 카탈로그

| Case ID | 종목명 (티커) | 시장 / 업종 | 성패 유형 | 핵심 태그 (트리거) | 1줄 핵심 교훈 | 상세 분석 파일 |
| :---: | :--- | :--- | :---: | :--- | :--- | :--- |
